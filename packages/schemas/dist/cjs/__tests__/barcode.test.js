...
const helper_1 = require("../src/barcodes/helper");
describe('validateBarcodeInput test', () => {
    ...
    test('gs1datamatrix', () => {
        ...
        expect((0, helper_1.validateBarcodeInput)(type, blank)).toEqual(false);
        expect((0, helper_1.validateBarcodeInput)(type, invalid_input_length)).toEqual(false);
    });
});
/**
...
describe('createBarCode', () => {
    ...
    describe('generate qrcode with default colours', () => {
        for (const t of tests) {
            ...
            test(`${t[0]}: ${t[1]}`, async () => {
                const buffer = (await (0, helper_1.createBarCode)({
                    type: 'qrcode',
                    input: t[1],
                    width: 10,
                    height: 10,
...
describe('barCodeType2Bcid test', () => {
    test('it maps the nw7 barcode type', () => {
        expect((0, helper_1.barCodeType2Bcid)('nw7')).toEqual('rationalizedCodabar');
    });
    test('it returns all other types as they are', () => {
        expect((0, helper_1.barCodeType2Bcid)('qrcode')).toEqual('qrcode');
        expect((0, helper_1.barCodeType2Bcid)('japanpost')).toEqual('japanpost');
        expect((0, helper_1.barCodeType2Bcid)('ean8')).toEqual('ean8');
        expect((0, helper_1.barCodeType2Bcid)('ean13')).toEqual('ean13');
        expect((0, helper_1.barCodeType2Bcid)('code39')).toEqual('code39');
        expect((0, helper_1.barCodeType2Bcid)('code128')).toEqual('code128');
        expect((0, helper_1.barCodeType2Bcid)('itf14')).toEqual('itf14');
        expect((0, helper_1.barCodeType2Bcid)('upca')).toEqual('upca');
        expect((0, helper_1.barCodeType2Bcid)('upce')).toEqual('upce');
        expect((0, helper_1.barCodeType2Bcid)('gs1datamatrix')).toEqual('gs1datamatrix');
    });
});
describe('mapHexColorForBwipJsLib text', () => {
    test('it strips a hex if there is one', () => {
        expect((0, helper_1.mapHexColorForBwipJsLib)('#ffffff')).toEqual('ffffff');
        expect((0, helper_1.mapHexColorForBwipJsLib)('#eee')).toEqual('eee');
        expect((0, helper_1.mapHexColorForBwipJsLib)('ffffff')).toEqual('ffffff');
    });
    test('it strips a hex from a fallback color if main color not defined', () => {
        expect((0, helper_1.mapHexColorForBwipJsLib)(undefined, '#ffffff')).toEqual('ffffff');
        expect((0, helper_1.mapHexColorForBwipJsLib)(undefined, '#eee')).toEqual('eee');
        expect((0, helper_1.mapHexColorForBwipJsLib)(undefined, 'ffffff')).toEqual('ffffff');
    });
    test('it defaults to black if neither color nor fallback passed', () => {
        expect((0, helper_1.mapHexColorForBwipJsLib)(undefined)).toEqual('000000');
    });
});
